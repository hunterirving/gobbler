...
function commentOnGobble(event)
{
	...
	window.location.replace("mailto:you@yoursite.com?subject=RE: \"" + gobble_text + "\"");
}
...
function appendGobbles() {
  ...
  const fragment = document.getElementById('gobble_template');
    ...
    const instance = document.importNode(fragment.content, true);
		...
		instance.querySelector('.thick_text').innerHTML = 'You';
		instance.querySelector('.thin_text').innerHTML = '@you<span class="dot">·</span><span class="date"></span>';
